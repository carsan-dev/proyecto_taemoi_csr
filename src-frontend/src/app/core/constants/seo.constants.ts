...
export const SEO_ROUTES = {
  ...
  taekwondo: {
    ...
    keywords:
      'taekwondo umbrete, taekwondo sevilla, escuela de taekwondo, clases de taekwondo, taekwondo aljarafe, taekwondo andalucia, taekwondo ninos, taekwondo adultos, club taekwondo sevilla',
  ...
  kickboxing: {
    ...
    keywords:
      'kickboxing light, kickboxing umbrete, kickboxing sevilla, kickboxing aljarafe, clases de kickboxing, kickboxing andalucia, kickboxing mujeres',
  ...
  pilates: {
    ...
    keywords:
      'pilates umbrete, pilates sevilla, pilates aljarafe, pilates balance, clases de pilates, pilates para adultos, pilates para mujeres, pilates andalucia',
  ...
  defensaPersonal: {
    ...
    keywords:
      'defensa personal femenina, defensa personal mujeres, autodefensa femenina, defensa personal sevilla, defensa personal umbrete, defensa personal aljarafe, defensa personal andalucia',
  ...
  horarios: {
    ...
    keywords:
      'horarios taekwondo umbrete, horarios kickboxing sevilla, horarios pilates umbrete, horarios defensa personal femenina, horarios moiskimdo',
  ...
  eventos: {
    ...
    keywords:
      'eventos taekwondo sevilla, competiciones taekwondo andalucia, eventos kickboxing, actividades artes marciales, torneos taekwondo',
  ...
  contacto: {
    ...
    keywords:
      'contacto taekwondo umbrete, escuela artes marciales sevilla, contacto kickboxing, contacto pilates, contacto defensa personal femenina',
