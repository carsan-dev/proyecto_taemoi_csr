...
export class EscaparatePrincipalComponent implements OnInit {
  ...
  imagenes = [
    {
      src: 'assets/media/fachada_escuela.webp',
      alt: 'Primera imagen del carrousel de la fachada de la escuela de taekwondo con un cartel que representa el nombre de la escuela y otro en el que se muestran los valores que se instruyen.',
    ...
    {
      src: 'assets/media/recepcion_escuela.webp',
      alt: 'Segunda imagen del carrousel de la recepcion de la escuela de taekwondo en la que se muestra la mesa de la entrada donde se solicitan todo tipo de gestiones.',
    ...
    {
      src: 'assets/media/interior_escuela.webp',
      alt: 'Tercera imagen del carrousel con el tatami de la escuela de taekwondo en la que se muestra cómo es la zona de entrenamiento de la misma.',
    ...
    {
      src: 'assets/media/maquinas_escuela.webp',
      alt: 'Cuarta imagen del carrousel con la zona de la escuela de taekwondo donde están las distintas máquinas para hacer ejercicios.',
