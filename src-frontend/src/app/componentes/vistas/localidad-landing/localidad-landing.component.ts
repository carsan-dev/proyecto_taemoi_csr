...
const LANDING_CONTENT: Record<LocalLandingKey, LocalLandingContent> = {
  aljarafe: {
    badge: 'Moiskimdo en el Aljarafe',
    introTitle: 'Escuela física en Umbrete para alumnos del Aljarafe',
    introParagraphs: [
      'Si buscas Moiskimdo en el Aljarafe, nuestras clases se imparten en Umbrete. Mantenemos la ubicación física real en Calle Parada de la Cigüeña 36, 41806 Umbrete, Sevilla.',
    ...
    reasonsTitle: 'Por qué elegir Moiskimdo si vienes desde el Aljarafe',
    reasons: [
    ...
    routeTitle: 'Moiskimdo sigue en Umbrete',
    routeParagraph:
  ...
  sevilla: {
    badge: 'Moiskimdo cerca de Sevilla',
    introTitle: 'Escuela en Umbrete para quienes buscan Moiskimdo desde Sevilla',
    introParagraphs: [
      'Moiskimdo entrena en Umbrete, cerca de Sevilla y del Aljarafe. La escuela mantiene su ubicación física real en Calle Parada de la Cigüeña 36, 41806 Umbrete, Sevilla.',
    ...
    reasonsTitle: 'Por qué venir a Moiskimdo desde Sevilla',
    reasons: [
    ...
    routeTitle: 'Umbrete es la sede real de Moiskimdo',
    routeParagraph:
      'Aunque muchos usuarios buscan Moiskimdo desde Sevilla, la escuela entrena en Umbrete y mantiene ahí su punto de encuentro, su dirección y la experiencia presencial completa.',
  },
};
