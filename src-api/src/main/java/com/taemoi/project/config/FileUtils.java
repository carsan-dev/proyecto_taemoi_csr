...
public class FileUtils {
	...
	public static String limpiarNombreArchivo(String nombreArchivo) {
		...
		String nombreLimpio = Normalizer.normalize(nombreArchivo, Normalizer.Form.NFD).replaceAll("[^\\p{ASCII}]", ""); // Elimina
																														// caracteres
																														// no
																														// ASCII
		...
		// Elimina caracteres no válidos para nombres de archivos (mantiene solo letras,
		// números, guiones bajos y puntos)
