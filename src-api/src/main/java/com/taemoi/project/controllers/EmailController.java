...
public class EmailController {
	...
	public void sendEmail(@Valid @RequestBody EmailRequest emailRequest) {
		String htmlMsg = "<!DOCTYPE html>" + "<html>" + "<head>" + "<style>"
				...
				+ "</div>" + "<div class='content'><label>Nombre:</label> <div>" + emailRequest.getNombre()
				+ "</div></div>" + "<div class='content'><label>Apellidos:</label> <div>" + emailRequest.getApellidos()
				+ "</div></div>" + "<div class='content'><label>Correo electrónico:</label> <div>"
				+ emailRequest.getEmail() + "</div></div>" + "<div class='content'><label>Asunto:</label> <div>"
				+ emailRequest.getAsunto() + "</div></div>" + "<div class='content'><label>Mensaje:</label> <div>"
				+ emailRequest.getMensaje() + "</div></div>"
