...
public class PDFServiceImpl implements PDFService {
	...
	public byte[] generarPreinscripcionFirmada(Preinscripcion p) {
		...
		String html = "<!DOCTYPE html><html><head><meta charset='UTF-8'/><style>"
				...
				+ ".head{border-bottom:3px solid #b7272d;padding-bottom:8px;margin-bottom:14px}.head-table{width:100%;border-collapse:collapse}.head-table td{padding:0;vertical-align:middle}.logo-cell{width:28mm}.head img{display:block;width:22mm}.title-cell{padding:0 5mm!important}h1{font-size:17pt;margin:0 0 3px;text-transform:uppercase;line-height:1.1}h2{font-size:11pt;color:#b7272d;margin:0}.ref-cell{width:36mm;text-align:right;font-weight:bold;white-space:nowrap}.section{margin:12px 0}.keep{page-break-inside:avoid}.section h3{font-size:11pt;border-bottom:1px solid #aeb6b9;padding-bottom:4px}.grid{width:100%;border-collapse:collapse}.grid td{border:1px solid #ccd2d4;padding:6px;text-align:left}.label{font-size:8pt;color:#59666b;text-transform:uppercase}.notice{background:#f4f1e9;border-left:4px solid #b7272d;padding:9px}.signature{height:27mm;max-width:70mm;object-fit:contain;border-bottom:1px solid #555}.foot{font-size:8pt;color:#59666b;margin-top:12px}"
