...
public class PreinscripcionService {
 ...
 private String nombrePublico(Grupo g){return switch(g.getDeporte()){case TAEKWONDO -> "Taekwondo";case KICKBOXING -> "Kickboxing";case PILATES -> "Pilates";case DEFENSA_PERSONAL_FEMENINA -> "Defensa personal femenina";};}
