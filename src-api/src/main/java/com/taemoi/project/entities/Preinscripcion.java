...
public class Preinscripcion {
 ...
 @ManyToOne(optional=false,fetch=FetchType.LAZY) @JoinColumn(name="turno_id") private Turno turno;
 @Lob @Column(name="turno_snapshot",nullable=false,columnDefinition="LONGTEXT") private String turnoSnapshot;
 ...
 public Turno getTurno(){return turno;} public void setTurno(Turno v){turno=v;} public String getTurnoSnapshot(){return turnoSnapshot;} public void setTurnoSnapshot(String v){turnoSnapshot=v;} public PlantillaPreinscripcion getPlantilla(){return plantilla;} public void setPlantilla(PlantillaPreinscripcion v){plantilla=v;} public String getPlantillaSnapshot(){return plantillaSnapshot;} public void setPlantillaSnapshot(String v){plantillaSnapshot=v;}
