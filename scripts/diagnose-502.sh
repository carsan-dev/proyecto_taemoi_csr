...
echo "     - Check backend logs for Flyway errors: docker logs taemoi-backend-prod"
echo "     - Verify flyway_schema_history exists and the database user can apply migrations"
echo ""
