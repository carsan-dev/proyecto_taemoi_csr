...
-- -----------------------------------------------------
-- Table `taemoi_test`.`alumno_reto_diario_log`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `taemoi_test`.`alumno_reto_diario_log` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `alumno_id` BIGINT NOT NULL,
  ...
  CONSTRAINT `FK_alumno_reto_diario_log_alumno_test`
    FOREIGN KEY (`alumno_id`)
    REFERENCES `taemoi_test`.`alumno` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `taemoi_test`.`registro_pendiente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `taemoi_test`.`registro_pendiente` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `email` VARCHAR(255) NOT NULL,
  `alumno_id` BIGINT NOT NULL,
...
-- -----------------------------------------------------
-- Table `taemoi_test`.`auditoria_evento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `taemoi_test`.`auditoria_evento` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
