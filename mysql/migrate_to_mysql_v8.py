...
def write_alumno_deporte(f, schema: str, stats: Dict):
    ...
    f.write("   `competidor`, `fecha_alta_competicion`, `fecha_alta_competidor_inicial`, `categoria_id`, `peso`, `fecha_peso`, \n")
    ...
    f.write("  COALESCE(a.competidor, (a.peso IS NOT NULL OR a.fecha_peso IS NOT NULL), false) as competidor,\n")
    f.write("  NULL as fecha_alta_competicion,\n")
    f.write("  NULL as fecha_alta_competidor_inicial,\n")
    f.write("  a.categoria_id,\n")
    f.write("  a.peso,\n")
    f.write("  a.fecha_peso,\n")
    f.write("  COALESCE(a.tiene_licencia, (a.numero_licencia IS NOT NULL OR a.fecha_licencia IS NOT NULL), false) as tiene_licencia,\n")
